...
static async fetchTransactionsForSelectedAccount(selectedAccount, userSession) {
    ...
    try {
        ...
        if (response.data && response.data.items && Array.isArray(response.data.items)) {
            ...
            // Prepare text for plain message
            ...
            // Handle channel-specific template generation
            switch (config.channel.toLowerCase()) {
                case "whatsapp":
                    templateData = {
                        ...
                        to: userSession.channelId // Replace with actual recipient number
                    };
                    break;
                ...
                case "facebook":
                    templateData = {
                        bodyText: bodyText,
                        to: userSession.channelId // Replace with actual recipient Facebook ID
                    };
                    break;
